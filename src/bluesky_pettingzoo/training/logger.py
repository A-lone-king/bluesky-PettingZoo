...
class CSVLoggerCallback(BaseCallback):
    ...
    def _init_callback(self) -> None:
        ...
        self._writer.writerow(
            ["timestep", "episode", "reward", "episode_length", "conflicts", "arrivals", "algorithm", "action_space", "timestamp"]
        )
        self._file.flush()
    ...
    def _on_step(self) -> bool:
        ...
        for i, done in enumerate(dones):
            ...
            reward = ep_info.get("r", self.locals.get("rewards", [0.0])[i] if i < len(self.locals.get("rewards", [])) else 0.0)
