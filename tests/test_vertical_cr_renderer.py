...
class TestVerticalCRRendererFrame:
    """Verify VerticalCR renders aircraft, waypoints, and altitude labels."""
    ...
    def test_render_frame_draws_aircraft(self, mock_base_pygame, mock_vcr_pygame, mock_common_pygame):
    ...
    @patch("bluesky_pettingzoo.rendering.vertical_cr_renderer.pygame")
    @patch("bluesky_pettingzoo.rendering.base_renderer.pygame")
    def test_render_frame_draws_altitude_labels(self, mock_base_pygame, mock_vcr_pygame, mock_common_pygame):
        mock_screen = MagicMock()
        mock_base_pygame.display.set_mode.return_value = mock_screen
        mock_base_pygame.Surface = MagicMock
        mock_font = MagicMock()
