"""Tests for scenario registry — all 10 scenarios registered."""
...
class TestScenarioRegistry:
    """Verify all 10 scenarios are registered."""
    ...
    def test_registry_has_exactly_10_entries(self):
        assert len(_SCENARIO_REGISTRY) == 10
